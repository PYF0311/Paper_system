...
jQuery('.formwrapper > input[name="major"]').change(function(){
	...
	$('.addmulti').click(function(){
			$('#dialogBox').dialogBox({
				...
				title: '上传文件',
				content: '<form id="upload" enctype="multipart/form-data" method="post"><input type="file" name="file" id="file"/><br /><span class="showUrl" id="showError"></span></form>只允许上传 csv、xls、xlsx 格式的文件，上传的表格，表头要与导出的格式⼀致，表格内容可为空。'
